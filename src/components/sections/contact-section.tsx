...
export function ContactSection({
  ...
  return (
    <section className="bg-brand-accent py-24 text-ink-primary saturate-130 sm:py-32">
      <Container>
        <Reveal className="mt-16 grid gap-10 lg:grid-cols-[1fr_360px] lg:items-end">
          <h2 className="max-w-5xl text-[clamp(3.5rem,8vw,8rem)] leading-[0.88] font-medium tracking-[-0.065em]">
            {content.heading}
          </h2>
          <div>
